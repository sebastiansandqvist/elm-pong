...
var $author$project$Main$ballSpeed = 1;
var $author$project$Main$initialState = {ballDx: $author$project$Main$ballSpeed, ballDy: $author$project$Main$ballSpeed, ballX: 0, ballY: 0, leftY: 0, rightY: 0, scoreL: 0, scoreR: 0};
var $author$project$Main$ballSize = 6;
var $author$project$Main$gameHeight = 400;
var $author$project$Main$gameWidth = 600;
var $author$project$Main$paddleWidth = 6;
var $author$project$Main$leftPaddleX = ((-$author$project$Main$gameWidth) / 2) + ($author$project$Main$paddleWidth / 2);
...
var $author$project$Main$paddleHeight = 50;
...
var $author$project$Main$rightPaddleX = ($author$project$Main$gameWidth / 2) - ($author$project$Main$paddleWidth / 2);
...
var $author$project$Main$render = F2(
	function (_v0, _v1) {
		...
		var ballY = _v1.ballY;
		var leftY = _v1.leftY;
		var rightY = _v1.rightY;
		var scoreL = _v1.scoreL;
		var scoreR = _v1.scoreR;
		return _List_fromArray(
			[
				A3(
				$evancz$elm_playground$Playground$rectangle,
				A3($evancz$elm_playground$Playground$rgb, 0, 0, 0),
				screen.width,
				screen.height),
				A3(
				$evancz$elm_playground$Playground$rectangle,
				A3($evancz$elm_playground$Playground$rgb, 100, 100, 100),
				...
				A2(
					...
					$author$project$Main$leftPaddleX,
					A3(
						$evancz$elm_playground$Playground$rectangle,
						A3($evancz$elm_playground$Playground$rgb, 255, 255, 255),
						$author$project$Main$paddleWidth,
						$author$project$Main$paddleHeight))),
				A2(
				$evancz$elm_playground$Playground$moveY,
				rightY,
				A2(
					$evancz$elm_playground$Playground$moveX,
					$author$project$Main$rightPaddleX,
					A3(
						$evancz$elm_playground$Playground$rectangle,
						A3($evancz$elm_playground$Playground$rgb, 255, 255, 255),
						$author$project$Main$paddleWidth,
				...
				A3(
					$evancz$elm_playground$Playground$rectangle,
					A3($evancz$elm_playground$Playground$rgb, 255, 255, 255),
					$author$project$Main$ballSize,
					$author$project$Main$ballSize)),
				A3(
				$evancz$elm_playground$Playground$move,
				-30,
				($author$project$Main$gameHeight / 2) + 20,
				A2(
					$evancz$elm_playground$Playground$words,
					$evancz$elm_playground$Playground$white,
					$elm$core$String$fromFloat(scoreL))),
				A3(
				$evancz$elm_playground$Playground$move,
				30,
				($author$project$Main$gameHeight / 2) + 20,
				A2(
					$evancz$elm_playground$Playground$words,
					$evancz$elm_playground$Playground$white,
					$elm$core$String$fromFloat(scoreR)))
			]);
	});
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$Main$handleGoal = function (pong) {
	var totalScore = $elm$core$Basics$round(pong.scoreL + pong.scoreR);
	var offscreenRight = _Utils_cmp(pong.ballX - ($author$project$Main$ballSize / 2), $author$project$Main$gameWidth / 2) > 0;
	var offscreenLeft = _Utils_cmp(pong.ballX + ($author$project$Main$ballSize / 2), (-$author$project$Main$gameWidth) / 2) < 0;
	var newBallDx = (!A2($elm$core$Basics$modBy, 2, totalScore)) ? $author$project$Main$ballSpeed : (-$author$project$Main$ballSpeed);
	return offscreenRight ? _Utils_update(
		$author$project$Main$initialState,
		{ballDx: newBallDx, scoreL: pong.scoreL + 1, scoreR: pong.scoreR}) : (offscreenLeft ? _Utils_update(
		$author$project$Main$initialState,
		{ballDx: newBallDx, scoreL: pong.scoreL, scoreR: pong.scoreR + 1}) : pong);
};
var $elm$core$Basics$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var $author$project$Main$getPaddleCollisionDx = function (pong) {
	var isCollidingRightY = _Utils_cmp(
		$elm$core$Basics$abs(pong.ballY - pong.rightY),
		($author$project$Main$paddleHeight / 2) + ($author$project$Main$ballSize / 2)) < 0;
	var isCollidingRightX = _Utils_cmp(
		$elm$core$Basics$abs(pong.ballX - $author$project$Main$rightPaddleX),
		($author$project$Main$paddleWidth / 2) + ($author$project$Main$ballSize / 2)) < 0;
	var isCollidingLeftY = _Utils_cmp(
		$elm$core$Basics$abs(pong.ballY - pong.leftY),
		($author$project$Main$paddleHeight / 2) + ($author$project$Main$ballSize / 2)) < 0;
	var isCollidingLeftX = _Utils_cmp(
		$elm$core$Basics$abs(pong.ballX - $author$project$Main$leftPaddleX),
		($author$project$Main$paddleWidth / 2) + ($author$project$Main$ballSize / 2)) < 0;
	return (isCollidingRightX && isCollidingRightY) ? (-$author$project$Main$ballSpeed) : ((isCollidingLeftX && isCollidingLeftY) ? $author$project$Main$ballSpeed : pong.ballDx);
};
var $author$project$Main$getVerticalCollisionDy = function (pong) {
	return (_Utils_cmp(pong.ballY, ((-$author$project$Main$gameHeight) / 2) + ($author$project$Main$ballSize / 2)) < 0) ? $author$project$Main$ballSpeed : ((_Utils_cmp(pong.ballY, ($author$project$Main$gameHeight / 2) - ($author$project$Main$ballSize / 2)) > 0) ? (-$author$project$Main$ballSpeed) : pong.ballDy);
};
var $author$project$Main$updateBall = function (pong) {
	var newDy = $author$project$Main$getVerticalCollisionDy(pong);
	var newDx = $author$project$Main$getPaddleCollisionDx(pong);
	return _Utils_update(
		pong,
		{ballDx: newDx, ballDy: newDy, ballX: pong.ballX + newDx, ballY: pong.ballY + newDy});
};
...
var $author$project$Main$updatePlayers = F2(
	function (keyboard, pong) {
		var paddleSpeed = 3;
		var isPressingW = A2($elm$core$Set$member, 'w', keyboard.keys);
		var isPressingUp = keyboard.up;
		var isPressingS = A2($elm$core$Set$member, 's', keyboard.keys);
		var newLeftY = isPressingW ? (pong.leftY + paddleSpeed) : (isPressingS ? (pong.leftY - paddleSpeed) : pong.leftY);
		var isPressingDown = keyboard.down;
		var newRightY = isPressingUp ? (pong.rightY + paddleSpeed) : (isPressingDown ? (pong.rightY - paddleSpeed) : pong.rightY);
		var clampUpper = ($author$project$Main$gameHeight / 2) - ($author$project$Main$paddleHeight / 2);
		var clampLower = ((-$author$project$Main$gameHeight) / 2) + ($author$project$Main$paddleHeight / 2);
		return {
			ballDx: pong.ballDx,
			ballDy: pong.ballDy,
			ballX: pong.ballX,
			ballY: pong.ballY,
			leftY: A3($elm$core$Basics$clamp, clampLower, clampUpper, newLeftY),
			rightY: A3($elm$core$Basics$clamp, clampLower, clampUpper, newRightY),
			scoreL: pong.scoreL,
			scoreR: pong.scoreR
		};
	});
var $author$project$Main$update = F2(
	function (_v0, pong) {
		...
		return $author$project$Main$handleGoal(
			$author$project$Main$updateBall(
				A2($author$project$Main$updatePlayers, keyboard, pong)));
	});
var $author$project$Main$main = A3($evancz$elm_playground$Playground$game, $author$project$Main$render, $author$project$Main$update, $author$project$Main$initialState);
